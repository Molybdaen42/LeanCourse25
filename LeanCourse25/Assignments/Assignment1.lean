...
* Make sure to follow the instructions in the README to install Lean and set up this repository
  locally.
...
also use lemmas. For instance let us prove a lemma about exponentiation of real numbers.
