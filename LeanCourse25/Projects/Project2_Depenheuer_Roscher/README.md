...
- Then we embedded them into ℝ³ resp. ℝ⁴ by formulas we found on Wikipedia resp. math.stackoverflow.com and mathoverflow.net. Sadly, the proof of injectivity and continuity of the inverse map is partly sorry'ed.
...
In the proof we have a few sorry's since we couldn't find out how to list all preimages of some point via Quotient.mk, i.e. all elements of the equivalence class of said point. This results in problems proving continuity and other things.
